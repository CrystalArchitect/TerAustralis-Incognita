...
<svelte:head>
  <title>Consent Transport - TerAustralis Incognita</title>
</svelte:head>

<div class="starline-container">
  <section class="starline-hero">
    <h1>Consent Transport</h1>
  ...
  <section class="starline-intro">
    <div class="intro-text">
      ...
      <p>
        Consent Transport emerged from a simple question: <em>"What if we built a network where every node
        is sovereign?"</em>
      </p>
    </div>
  </section>
  ...
  <section class="starline-spec">
    ...
    <p>
      Consent Transport v1 is fully specified and tested. The protocol covers:
    </p>
    <ul>
