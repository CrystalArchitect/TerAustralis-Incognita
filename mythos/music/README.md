...
| [`starline-rivers.mp3`](starline-rivers.mp3) | Starline Rivers — *shares its name with canon art* | **not in canon** | 4:24 | 2026-07-21T22:34:18Z | `0e15fcf9-4291-4de8-8418-7b4348c7fc52` | **unconfirmed** |
...
- **Suno plan** — free, Pro, or Premier, *at the time the track was
  ...
  **Why every row still says "unconfirmed."** There is circumstantial evidence
  ...
  restricted audio downloads to paid accounts, and all eleven files were
  ...
  **And the answer may differ per track.** Five recordings come from a single
  week in May 2026; six more from 17, 21, 30 and 31 July. A subscription can
  ...
  In practice two answers probably settle all eleven: whatever plan was active
