...
| `lattice-components.jpeg` | The four Built components as a labelled lattice — Lumina (sovereign companion), Starline (P2P memory exchange), Starline Weaver (multi-AI coordination), CrystalBridge (consent layer) |
