...
**As of:** 2026-08-29 (cross-repo memory model restructured and merged to main via PR #129; memory-state model design hypothesis merged to main via PR #131; Starline Arsenal expanded 13 → 25 models, merged to main via PR #130)
