...
**As of:** 2026-08-29 (cross-repo memory model restructured and merged to main via PR #129; memory-state model design hypothesis merged to main via PR #131; Starline Arsenal expanded 13 → 25 models via PR #130, then reconciled to 31 and fully verified 1–31 on this branch, not yet merged)
